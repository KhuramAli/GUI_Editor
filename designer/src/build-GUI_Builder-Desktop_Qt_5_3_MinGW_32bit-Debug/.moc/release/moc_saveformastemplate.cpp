...
#include "../../../designer/saveformastemplate.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SaveFormAsTemplate_t, stringdata) + ofs \
...
const QMetaObject SaveFormAsTemplate::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SaveFormAsTemplate.data,
      qt_meta_data_SaveFormAsTemplate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SaveFormAsTemplate.stringdata))
