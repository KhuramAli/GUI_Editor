...
void MainWindowBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainWindowBase::closeEventReceived)) {
                *result = 0;
            }
        }
    }
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DockedMdiArea_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
void DockedMdiArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DockedMdiArea::fileDropped)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DockedMdiArea::staticMetaObject = {
    { &QMdiArea::staticMetaObject, qt_meta_stringdata_DockedMdiArea.data,
      qt_meta_data_DockedMdiArea,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DockedMdiArea.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ToolBarManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject ToolBarManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ToolBarManager.data,
      qt_meta_data_ToolBarManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ToolBarManager.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DockedMainWindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
void DockedMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DockedMainWindow::fileDropped)) {
                *result = 0;
            }
        }
        {
            typedef void (DockedMainWindow::*_t)(QDesignerFormWindow * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DockedMainWindow::formWindowActivated)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject DockedMainWindow::staticMetaObject = {
    { &MainWindowBase::staticMetaObject, qt_meta_stringdata_DockedMainWindow.data,
      qt_meta_data_DockedMainWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DockedMainWindow.stringdata))
