...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDesigner_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 71, 14)
    ...
    "const char*\0message\0initialize\0"
    "callCreateForm"
};
...
void QDesigner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QDesigner::initialized)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QDesigner::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_QDesigner.data,
      qt_meta_data_QDesigner,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDesigner.stringdata))
