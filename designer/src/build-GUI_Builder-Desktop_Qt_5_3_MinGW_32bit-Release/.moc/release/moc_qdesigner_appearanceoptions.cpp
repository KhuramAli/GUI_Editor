...
#include "../../../designer/qdesigner_appearanceoptions.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDesignerAppearanceOptionsWidget_t, stringdata) + ofs \
...
void QDesignerAppearanceOptionsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QDesignerAppearanceOptionsWidget::uiModeChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QDesignerAppearanceOptionsWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QDesignerAppearanceOptionsWidget.data,
      qt_meta_data_QDesignerAppearanceOptionsWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDesignerAppearanceOptionsWidget.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QDesignerAppearanceOptionsPage_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
void QDesignerAppearanceOptionsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QDesignerAppearanceOptionsPage::settingsChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QDesignerAppearanceOptionsPage::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDesignerAppearanceOptionsPage.data,
      qt_meta_data_QDesignerAppearanceOptionsPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDesignerAppearanceOptionsPage.stringdata))
